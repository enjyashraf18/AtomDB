...
def create_hdf5_file(DATASETS_H5FILE, fields, dataset, mult):
    ...
    properties_folder = DATASETS_H5FILE.create_group(
    ...
    species_info_table = DATASETS_H5FILE.create_table(
        properties_folder, "species_info", SpeciesInfo, "Species Information"
    )
    ...
    for config in SLATER_PROPERTY_CONFIGS:
        if "SpeciesInfo" in config:
            ...
            create_properties_tables(DATASETS_H5FILE, properties_folder, config, fields[prop_name])
